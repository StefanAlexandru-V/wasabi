...
export function SignInButton() {
  ...
  return (
    ...
    >
      ...
      {!loading && (
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="opacity-50 transition-transform group-hover:translate-x-0.5">
